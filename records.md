...
- **w(2;3,36) > 1259** and **w(2;3,39) > 1420** — M5 T2 improvements
  by two over the AKS 2014 appendix bounds, with complete
  verifier-accepted certificates at both intermediate and current lengths.
  Literature re-sweep pending before any external record claim.
